...
import { PolymorphicProps, SlotComponentProps } from '@mui/base/utils';
import { UseMenuListboxSlotProps } from '@mui/base/useMenu';
...
export interface MenuOwnProps {
     ...
     */
    slotProps?: {
        root?: SlotComponentProps<'div', MenuRootSlotPropsOverrides, MenuOwnerState> & Partial<React.ComponentPropsWithoutRef<typeof Popper>>;
