...
import * as orders from '@stripe/stripe-js/types/stripe-js/orders';
import * as tokens from '@stripe/stripe-js/types/stripe-js/token-and-sources';
import * as elements from '@stripe/stripe-js/types/stripe-js/elements';
import * as financialConnections from '@stripe/stripe-js/types/stripe-js/financial-connections';
import * as ephemeralKeys from '@stripe/stripe-js/types/stripe-js/ephemeral-keys';
...
import {CheckoutLocale, RedirectToCheckoutOptions} from '@stripe/stripe-js/types/stripe-js/checkout';
import {PaymentRequestOptions, PaymentRequest} from '@stripe/stripe-js/types/stripe-js/payment-request';
import {StripeElement, StripeElementLocale} from '@stripe/stripe-js/types/stripe-js/elements-group';
